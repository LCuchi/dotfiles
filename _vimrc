...
if has('mac')
  ...
  let g:php_cs_fixer_path = '/tools/php-cs-fixer.phar'
endif
...
" vim-php-cs-fixer
nnoremap  [php-cs-fixer]   <Nop>
nmap      <Space>f  [php-cs-fixer]
autocmd FileType php nnoremap <silent> [php-cs-fixer] :<C-u>call PhpCsFixerFixFile()<CR>
